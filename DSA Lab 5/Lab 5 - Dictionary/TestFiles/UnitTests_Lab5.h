...
#pragma region Test - Pair Constructor
	static int Battery_PairConstructor();
...
#pragma region Test - Dictionary Constructor
	static int Battery_DictionaryConstructor();
...
#pragma region Test - Clear
	...
	static FailResult Fail_Clear_MemoryIsAllocated();
...
#pragma region Test - Insert New Pair
	static int Battery_Insert_NewKey();
	...
	static FailResult Fail_Insert_NewKey_NoPairAdded();
...
#pragma region Test - Insert Overwrite Existing Key
	static int Battery_Insert_OverwriteExistingKey();
...
#pragma region Test - Find (Key Exists)
	static int Battery_Find_KeyExists();
...
#pragma region Test - Find (Key Does not Exist)
	static int Battery_Find_KeyDoesNotExist();
...
#pragma region Test - Remove (Key Exists)
	static int Battery_Remove_KeyExists();
...
#pragma region Test - Remove (Key Does not Exist)
	static int Battery_Remove_KeyDoesNotExist();
