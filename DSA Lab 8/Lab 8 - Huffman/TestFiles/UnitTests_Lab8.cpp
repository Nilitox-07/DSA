...
#ifdef _DEBUG
#pragma comment(lib, "HuffmanLib.lib")
#else
...
#ifndef _GRADING
	results::Log("Huffman.fslog", { "Huffman.h" });
...
FailResult UnitTests_Lab8::Fail_Decompress_UsesEofForIfstream() {
	...
	result.deduction = 3;
	result.msg = "Should not use eof for BitIfstream as looping condition. Valid binary data may not take up all bits of last byte";
