...
#pragma region Test - Populate Letter Values
	static int Battery_PopulateLetterValues();
...
#pragma region Test - Get Letter Value
	static int Battery_GetLetterValue();

	static FailResult Fail_GetLetterValue_UsesToUpperOrToLower();
...
#pragma region Test - Find Word Score
	static int Battery_FindWordScore();

	static FailResult Fail_FindWordScore_DoesNotCallFind();
	static FailResult Fail_FindWordScore_UsesLoop();
