...
#else
	Node* val50 = new Node(RandomInt(50,59));
	Node* val25 = new Node(RandomInt(20,29));
	Node* val75 = new Node(RandomInt(70,79));
	Node* val10 = new Node(RandomInt(1,10));
	Node* val35 = new Node(RandomInt(30,39));
	Node* val65 = new Node(RandomInt(65,69));
	Node* val100 = new Node(RandomInt(81,100));
	Node* val15 = new Node(RandomInt(11,19));
	Node* val40 = new Node(RandomInt(40,49));
	Node* val60 = new Node(RandomInt(61,64));
	Node* val80 = new Node(RandomInt(80,89));
#endif
...
bool UnitTests_Lab7::Pass_AssignmentOperator_CorrectAmountOfMemoryAllocated() {
	...
	assign.mRoot->left->parent = assign.mRoot->right->parent = assign.mRoot;
